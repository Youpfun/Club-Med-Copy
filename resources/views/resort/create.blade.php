        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Identité et Localisation (Obligatoire). Le reste est optionnel.</p>
                </div>
            ...
            <form action="{{ route('resort.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="bg-white rounded-xl shadow border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <label class="block text-sm font-bold text-gray-800 mb-1">Pays du Resort <span class="text-red-600">*</span></label>
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <label class="block text-sm font-bold text-gray-800 mb-1">Nom du Resort <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            ...
                            <select name="nbtridents" class="w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div class="bg-white rounded-xl shadow border border-gray-200 p-6">
                    <h2 class="text-xl font-bold text-gray-900 border-b pb-2 mb-6">2. Environnement & Ski (Optionnel)</h2>
                    <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl shadow border border-gray-200 p-6">
                    <h2 class="text-xl font-bold text-gray-900 border-b pb-2 mb-4">3. Photos du Séjour (Optionnel)</h2>
                ...
                <div class="bg-white rounded-xl shadow border border-gray-200 p-6">
                    <div class="flex justify-between items-center border-b pb-2 mb-6">
                        <h2 class="text-xl font-bold text-gray-900">4. Restaurants & Bars (Optionnel)</h2>
                    ...
                    <div id="restaurants-container" class="space-y-4">
                        <p class="text-sm text-gray-500 italic mb-4">Vous pourrez ajouter les restaurants plus tard.</p>
                    </div>
                </div>
                ...
                <div class="pt-6 border-t flex justify-between items-center bg-white/90 backdrop-blur-sm py-4 sticky bottom-0 z-50">
                    ...
                    <button type="submit" name="action" value="save_exit" class="text-gray-500 hover:text-gray-800 font-bold underline transition decoration-gray-300 hover:decoration-gray-800">
                        Sauvegarder et quitter
                    </button>

                    {{-- BOUTON 2 : SUIVANT --}}
                    <button type="submit" name="action" value="next" class="flex items-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg rounded-full shadow-xl transform transition hover:scale-105">
                        <span>Suivant : Configurer l'Hébergement</span>
